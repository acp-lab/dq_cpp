...
void NMPCControlNodelet::referenceCallback(
  ...
  if (quadrotor_payload == int(2)) {
    ...
    for (int i = 0; i < kSamples; i++) {
      ...
      H_plus_t << t(0), -t(1), -t(2), -t(3), t(1), t(0), -t(3), t(2), t(2),
          t(3), t(0), -t(1), t(3), -t(2), t(1), t(0);
      ...
      H_plus_aux << aux_value(0), -aux_value(1), -aux_value(2), -aux_value(3),
          ...
          aux_value(3), aux_value(0), -aux_value(1), aux_value(3),
          -aux_value(2), aux_value(1), aux_value(0);
